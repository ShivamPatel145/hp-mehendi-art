...
export default function Home() {
  const featuredImages = galleryImages.slice(0, 3); // Grab the first 3 images
  const heroImage = galleryImages[12] || featuredImages[0]; // Select a good image for the hero background
